...
class ResourceProfile(google.protobuf.message.Message):
    ...
    def executor_resources(
        ...
        """Resource requests for executors. Mapped from the resource name
    ...
    def task_resources(
        ...
        """Resource requests for tasks. Mapped from the resource name
        (e.g., cores, memory, CPU) to its specific request.
        """
    def __init__(
        self,
...
class ExecutorResourceRequest(google.protobuf.message.Message):
    ...
    """Optional script used to discover the resources. This is required on some cluster managers
    that don't tell Spark the addresses of the resources allocated. The script runs on
    Executors startup to discover the addresses of the resources available.
    """
    vendor: builtins.str
    """Optional vendor, required for some cluster manager."""
    def __init__(
        self,
        *,
        resource_name: builtins.str = ...,
