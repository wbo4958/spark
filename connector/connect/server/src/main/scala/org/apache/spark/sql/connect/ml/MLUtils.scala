...
//  def invokeMethod[T: TypeTag](obj: T, methodName: String, args: Any*): Any = {
//    val mirror = runtimeMirror(obj.getClass.getClassLoader)
//    val instanceMirror = mirror.reflect[T](obj)
//    val methodSymbol = typeOf[T].decl(TermName(methodName)).asMethod
//    instanceMirror.reflectMethod(methodSymbol)(args: _*).asInstanceOf
//  }
}
